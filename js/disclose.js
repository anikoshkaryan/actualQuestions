...
//*for dislosed.html .disclose-standardInfo-item's part

$(document).on("click",".disclose-standardInfo-item", function () {
    $(".disclose-standardInfo-item").removeClass("green");
    $(this).addClass("green");
    ...
    if (!$('.'+dataId).hasClass("active-ul")){
        $('.disclose-ul').removeClass("active-ul");
        $('.'+dataId).addClass("active-ul");
    }
});
